...
2. Click on the folder’s address bar at the top. It will display the full path to the folder. Copy. 
...
2. In the **“Advanced”** tab, click the **“Environment Variables...”** button at the bottom right.
